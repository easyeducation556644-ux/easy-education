        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
          ...
          <div className="mb-6 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
            ...
            <div className="text-sm text-yellow-600 dark:text-yellow-300 space-y-1">
              <p>• সর্বোচ্চ <strong>২টি ডিভাইস</strong> থেকে একসাথে লগইন করতে পারবেন</p>
              <p>• ২টির বেশি ডিভাইসে লগইন করলে আপনার অ্যাকাউন্ট <strong>৩০ মিনিটের জন্য ব্যান</strong> হবে</p>
