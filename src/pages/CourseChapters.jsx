  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-6xl px-4 py-6">
        ...
        {course?.telegramLink && currentUser && hasAccess && !isArchiveSubject && !subject && (
          <div className="mb-6">
            <button
        ...
        {/* Telegram Join Section - Show after chapters grid */}
              ...
              {telegramSubmitted ? (
                ...
                <>
                  ...
                  <div className="border-t border-border pt-4">
                    ...
                    <p className="block text-xs font-medium text-muted-foreground mb-3">
